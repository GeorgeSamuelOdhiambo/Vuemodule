...
const props = defineProps(['brandid', 'productid'])
...
onMounted(async () => {
  ...
  // brandid.value = route.params.brandid
  await getArticlesbyproductandbrand({ suppid: props.brandid, ptid: props.productid })
